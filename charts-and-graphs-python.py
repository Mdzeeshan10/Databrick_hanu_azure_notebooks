...
# MAGIC Only the first 1000 rows are displayed in the table view.
...
# MAGIC %md ### Configure tables with **Plot Options...**.
...
# MAGIC %md
# MAGIC
# MAGIC To create a Pivot table, click the Graph icon below a result and select **Pivot**.
...
# MAGIC * **Sum** was selected as the aggregation method, which means rows are summed for pivoting.
